...
def problem3(point, circle1, circle2, window):
    ...
    linea = rg.Line(line1.get_midpoint(),line2.get_midpoint())
    lineb = rg.Line(line1.get_midpoint(), line3.get_midpoint())
    linec = rg.Line(line3.get_midpoint(), line2.get_midpoint())
    linea.color = circle2.fill_color
    lineb.color = circle2.fill_color
    linec.color = circle2.fill_color
